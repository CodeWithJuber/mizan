...
class SkillRegistry:
    ...
    def list_skills(self) -> list[dict]:
        ...
        known = {
            ...
            "raqib_scanner": {
                "display": "Raqib Security Scanner",
                "arabic": "رقيب",
